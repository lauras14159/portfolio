  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-background z-50">
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        <div className="text-2xl font-bold text-accent">MyPortfolio</div>
        ...
        <div className="md:hidden">
          ...
          <label
            htmlFor="menu-toggle"
            className="cursor-pointer flex flex-col w-6 h-5 justify-between"
          >
            <span className="block h-0.5 w-full bg-text"></span>
            <span className="block h-0.5 w-full bg-text"></span>
            <span className="block h-0.5 w-full bg-text"></span>
          </label>
